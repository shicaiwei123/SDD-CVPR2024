...
def build_teacher(cfg):
    ...
    if not 'Retina' in teacher_cfg.MODEL.META_ARCHITECTURE:
        ...
        teacher_cfg.defrost()
        teacher_cfg.MODEL.ROI_BOX_HEAD.USE_FED_LOSS=False
        teacher_cfg.MODEL.ROI_BOX_HEAD.USE_SIGMOID_CE = False
        teacher_cfg.MODEL.ROI_BOX_HEAD.FED_LOSS_NUM_CLASSES = 50
